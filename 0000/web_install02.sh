...
# 配置文件下载地址（注意地址修正）
CONFIG_DOWN_SITE="https://raw.githubusercontent.com/allok1985/web_install/master/0000"
...
opkg install $PHPWEB/ipk/zoneinfo-asia_2017b-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/tar_1.29-3_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/wget_1.18-2_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-gd_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-session_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-pdo_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-pdo-mysql_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-mysqli_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/libmysqlclient_5.1.73-2_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-mcrypt_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/libmcrypt_2.5.8-2_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-mbstring_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-cgi_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-fastcgi_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-cgi_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-xml_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-ctype_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-curl_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-exif_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-ftp_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-iconv_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-json_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-sockets_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-sqlite3_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-tokenizer_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-zip_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-simplexml_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-dom_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-xmlwriter_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-xmlreader_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-hash_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-fpm_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/php7-mod-opcache_7.1.1-1_x86_64.ipk --force-depends
opkg install $PHPWEB/ipk/mysql-server_5.1.73-2_x86_64.ipk --force-depends
